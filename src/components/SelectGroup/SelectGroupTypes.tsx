...
interface SelectGroupTypesProps {
  value: string;
  onChange: (e: React.ChangeEvent<HTMLSelectElement>) => void;
}

const SelectGroupTypes: React.FC <SelectGroupTypesProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="mb-4.5">
      <label className="mb-2.5 block text-black dark:text-white">Types</label>
