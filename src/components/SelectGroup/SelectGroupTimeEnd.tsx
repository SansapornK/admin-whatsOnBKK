...
interface SelectGroupTimeEndProps {
  value: string;
  onChange: (e: React.ChangeEvent<HTMLSelectElement>) => void;
}

const SelectGroupTimeEnd: React.FC<SelectGroupTimeEndProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="mb-4.5">
      <label className="mb-2.5 block text-black dark:text-white">Time End</label>
...
export default SelectGroupTimeEnd;
